...
export const FAQ_CARD_VARIANTS = tv({
  base: "relative overflow-hidden flex min-h-60 min-w-70 w-70 py-4 pl-6 pr-10 flex-col justify-between rounded-lg shadow-md hover:shadow-2xl transition-all duration-300 ease-in-out",
  variants: {
    color: {

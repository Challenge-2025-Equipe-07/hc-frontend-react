...
export const INPUT_VARIANTS = tv({
  slots: {
    wrapper: "grid w-full gap-y-1 auto-rows-max",
  ...
  variants: {
    color: {
      light: {
        label: "text-blue-600",
        base: "w-full rounded-md border border-gray-300 px-4 py-2 placeholder-gray-300 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none",
      },
      blue: {
        label: "text-blue-600",
